IF EXISTS(SELECT 1 FROM SYSOBJECTS WHERE [Name] = 'FI_SP_PesqCliente' AND [type] = 'P')
BEGIN
    DROP PROCEDURE [dbo].[FI_SP_PesqCliente]
	PRINT 'Procedure FI_SP_PesqCliente foi descartado.'
END
GO
...
PRINT 'Procedure FI_SP_PesqCliente foi criado.'
